...
class InstructionSimplifierX86_64Visitor : public HGraphVisitor {
 public:
  InstructionSimplifierX86_64Visitor(HGraph* graph,CompilerDriver* compiler_driver,  OptimizingCompilerStats* stats)
      : HGraphVisitor(graph),
...
class InstructionSimplifierX86_64 : public HOptimization {
 public:
  InstructionSimplifierX86_64(HGraph* graph, CompilerDriver* compiler_driver,  OptimizingCompilerStats* stats)
  ...
  void Run() OVERRIDE {
    InstructionSimplifierX86_64Visitor visitor(graph_, compiler_driver_, stats_);
