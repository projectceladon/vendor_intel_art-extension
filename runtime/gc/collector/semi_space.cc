...
SemiSpace::SemiSpace(Heap* heap, bool generational,
                     ...
                     bool need_aging_table, bool support_parallel)
...
class MarkStackCopyTask : public Task {
 public:
  ...
  ALWAYS_INLINE void MarkStackPush(Object* obj) REQUIRES_SHARED(Locks::mutator_lock_) NO_THREAD_SAFETY_ANALYSIS {
  ...
  class SSMarkObjectParallelVisitor {
   public:
    ...
    void operator()(Object* obj, MemberOffset offset, bool /* static */) const ALWAYS_INLINE
      ...
      semi_space_->MarkParallel(reinterpret_cast<mirror::ObjectReference<kPoisonHeapReferences, mirror::Object>*>(
                                obj->GetFieldObjectReferenceAddr<kVerifyNone>(offset)), chunk_task_);
      }
