...
public class Main {
    ...
    // simple AUR example for try-catch block with DivZeroCheck in try section: environment of DivZeroCheck removed
    // environemnt of NullCheck and instruction LoadException (no side effects) outside of try-catch block are also removed
