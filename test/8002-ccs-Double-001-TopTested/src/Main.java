...
/**
*
* Expected result: sinking for Double occurs if number of iterations is less than 1025
* or if we get to Infinity for Add/Sub/Mul or to 0 for Div/Rem
*
**/

public class Main {                                                                                                                                                   
    final int iterationsLessThanThreshold = 1015;
    final int iterationsGreaterThanThreshold = 1030;
